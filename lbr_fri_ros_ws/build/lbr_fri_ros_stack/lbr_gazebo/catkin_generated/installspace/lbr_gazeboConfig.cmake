...
if("FALSE" STREQUAL "TRUE")
  set(lbr_gazebo_SOURCE_PREFIX /home/dvij/learning_table_tennis_from_scratch/lbr_fri_ros_ws/src/lbr_fri_ros_stack/lbr_gazebo)
  set(lbr_gazebo_DEVEL_PREFIX /home/dvij/learning_table_tennis_from_scratch/lbr_fri_ros_ws/devel)
  ...
  set(lbr_gazebo_INSTALL_PREFIX /home/dvij/learning_table_tennis_from_scratch/lbr_fri_ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lbr_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
