...
# from utils.constants import AZURE_KINECT_COLOR_HEIGHT as COLOR_HEIGHT
# from utils.constants import AZURE_KINECT_COLOR_WIDTH as COLOR_WIDTH

from utils.constants import REAL_SENSE_COLOR_HEIGHT as COLOR_HEIGHT
from utils.constants import REAL_SENSE_COLOR_WIDTH as COLOR_WIDTH
...
class AnnotationReviewer():
    ...
    def review_scene_annotations(self, scene_dir):
        ...
        # render scene
        r = pyrender.OffscreenRenderer(COLOR_WIDTH, COLOR_HEIGHT)
        ...
        colors = np.tile(np.expand_dims(np.expand_dims(colors, 0), 0), (COLOR_HEIGHT, COLOR_WIDTH, 1, 1))
        ...
        h, w = int(COLOR_HEIGHT / 2), int(COLOR_WIDTH / 2)
