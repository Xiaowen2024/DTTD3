...
def main():
    ...
    parser.add_argument('--depth_type', type=str, default='ARKit', choices=['ARKit', 'AVFoundation'], help='choose your data type')
    ...
    iphone_data_processing.process_iphone_scene_data(scene_dir, args.camera_name, args.depth_type)
